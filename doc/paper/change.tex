...
\begin{figure}[!t]
    ...
    (a) Validation loss, top-1 accuracy, and top-4 accuracy for neural-network period recovery on an 18-qubit instance.
...
The neural net trained successfully. As shown in Fig.~\ref{fig:recovery_pipeline}(a), the neural network achieves rapid convergence when trained on an 18-qubit instance. Both the top-1 (correct period ranked first) and top-4 accuracies increase swiftly within a few epochs.
