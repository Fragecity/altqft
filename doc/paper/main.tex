...
Fig.~\ref{fig:gate_noise_accuracy} reports the 18-qubit gate-level Pauli-noise sweep: top-1 accuracy drops from \(0.9059\) at \(10^{-3}\) to \(0.1412\) at \(10^{-1.5}\). Details are in Appendix~\ref{app:noise_robustness_details}.
