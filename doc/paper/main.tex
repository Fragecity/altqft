...
Theorem~\ref{thm:hp1_first_order_fisher_transfer_maintext} shows that, within the square-root resolvability window, \myqc{} circuits retain exponentially growing information about the hidden subgroup generator.
