...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.8\columnwidth]{fig/hp1_sumPP.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{fig/vpq_dist.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.9\linewidth]{fig/mle.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.6\linewidth]{fig/ml_arch.pdf}
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.78\textwidth]{fig/gate_noise_accuracy.pdf}
